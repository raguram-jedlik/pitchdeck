...
export default function Nav() {
  ...
  return (
    <>
      ...
      />
      <header className="fixed top-0 left-0 right-0 z-40 flex items-start justify-between mix-blend-difference">
        ...
        <span className="mr-6 mt-3 font-display text-[0.65rem] font-medium uppercase tracking-[0.18em] text-paper/80 md:mr-10 md:mt-4 md:text-xs">
